...
import { User, ShoppingCart, Anchor } from "lucide-react";
...
export function Header({ clearCart, addToCart }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white text-gray-800 shadow-md">
      <div className="container flex h-16 items-center justify-between px-4 md:px-6">
        <Link href="/" className="flex items-center gap-2">
          <Anchor className="h-6 w-6 text-blue-700"/>
          <span className="text-xl font-bold text-blue-700">Miami Yates</span>
        </Link>
